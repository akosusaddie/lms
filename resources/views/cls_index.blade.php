<?php 
session_start();
define('BASE_URL', 'http://localhost/lms_new/'); 
			...
			<div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--ver kt-page">
				...
				<div class="kt-aside  kt-aside--fixed  kt-grid__item kt-grid kt-grid--desktop kt-grid--hor-desktop" id="kt_aside">
					<!-- begin:: Aside Menu -->
							...
							<?php include('cls_leftmenu.blade.php'); ?>
				...
				<div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor kt-wrapper" id="kt_wrapper">
					...
					<div id="kt_header" class="kt-header kt-grid kt-grid--ver  kt-header--fixed ">
						...
						<h3 class="kt-header__title kt-grid__item kt-align-right primary" style="margin-left: 200px;">
...
<!-- end:: Header Topbar -->
					...
					<div class="kt-content  kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor kt-container p-5" id="current_area1">
					
							<?php include('cls_dashboard.blade.php'); ?>
