...
<div class="kt-portlet kt-portlet--mobile">
										<div class="kt-portlet__head">
											<div class="kt-portlet__head-label">
												<h3 class="kt-portlet__head-title">
													ASSESSMENT OF CHARGES FOR LEASE PREPARATION
												</h3>
											</div>
										</div>
										<div class="row">
					...
					<div  class="col-lg-9 col-md-9 col-sm-12 mt-5">
						...
						<input onclick ="show_leaseRes();" id="leaseValres" name="lease_type" type="radio" value="residential"> Residential
												<span></span>
														</label>
									<label class="kt-radio kt-radio--solid kt-radio--brand">
				<input onclick ="show_leaseCom();" id="leaseValcomm" name="lease_type" type="radio" value="commercial"> Commercial
									<span></span>
														</label>
													
														</div>
										<span class="form-text text-muted">Please Choose Valuation Type</span>
													</div>
													<div class="col"></div>
										</div>
										
										<div class="kt-portlet__body" id="lease_valResident" style="display: none">
...
<input type="text" name="new_location" class="form-control">
								   ...
								   <div class="col-lg-4">
								   <label >Rate:</label>
								   <span name="sr" id="show_rate1" style="display: none;">GHC 100,000.00</span>
								   <span name="sr" id="show_rate2" style="display: none;">GHC 60,000.00</span>
								   <span name="sr" id="show_rate3" style="display: none;">GHC 20,000.00</span>
								   </div>
								   </div>
								   ...
								   <div class="col-lg-4"></div> 
										...
										<div class="row">
										<div class="col">
								   <button onclick="compute_dmoney();" type="button" name="cal_dmoney" value="cal_dmoney" class="btn btn-primary">Calculate Drink Money</button>
								   </div>
								   <div class="col"></div>
								   <div class="col"></div> 
										</div>
								   ...
								   <div class="col"></div> 
									...
									<div class="kt-portlet__body" id="lease_valComm" style="display: none">
										<form  method="post" action="cal_process.php">
                                   <div class="row">
								   <div class="col-lg-4">
								   <div class="form-group">
