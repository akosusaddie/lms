											...
											<div class="kt-widget kt-widget--user-profile-1">
												<div class="kt-widget__head">
													<div class="kt-widget__media">
														<img src="<?php echo BASE_URL ?>assets/media/users/100_1.jpg" alt="image">
													</div>
												...
												<div class="kt-widget__body">
													<div class="kt-widget__content">
														<div class="kt-widget__info">
															...
															<a href="javascript:;" class="kt-widget__data"><?php echo $_SESSION['email'];?></a>
														</div>
														<div class="kt-widget__info">
														<span class="kt-widget__label">Phone:</span>
															<a href="javascript:;" class="kt-widget__data"><?php echo $_SESSION['contact'];?></a>
														</div>
														<div class="kt-widget__info">
													...
													<div class="kt-widget__items">
														<a href="javascript:;" onclick="getstep('profile_overview');" class="kt-widget__item kt-widget__item--active">
