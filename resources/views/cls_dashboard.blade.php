<!-- begin:: Content -->
						<div class="kt-portlet kt-portlet--mobile" style="background-image: url('assets\media\logos\lc_image1.jpg'); background-repeat: no-repeat; background-size: cover;">
        ...
        <rect id="Rectangle-23" fill="#000000" opacity="0.3" x="10" y="16" width="4" height="4" rx="2"/>
												...
												<div class="kt-iconbox__desc">
													<h3 class="kt-iconbox__title">
														<a class="kt-link" href="#">Notifications</a>
													</h3>
    ...
    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        ...
        <path d="M6,7 L15,7 C15.5522847,7 16,7.44771525 16,8 C16,8.55228475 15.5522847,9 15,9 L6,9 C5.44771525,9 5,8.55228475 5,8 C5,7.44771525 5.44771525,7 6,7 Z M6,11 L11,11 C11.5522847,11 12,11.4477153 12,12 C12,12.5522847 11.5522847,13 11,13 L6,13 C5.44771525,13 5,12.5522847 5,12 C5,11.4477153 5.44771525,11 6,11 Z" id="Combined-Shape" fill="#000000" opacity="0.3"/>
												...
												<div class="kt-iconbox__desc">
													<h3 class="kt-iconbox__title">
														<a class="kt-link" href="#">Total Messages</a>
													</h3>
													<div class="kt-iconbox__content">
														<h3 style="text-align: center;"><span class="kt-widget20__number kt-font-brand">170+</span></h3>
													</div>
												</div>
											</div>
										</div>
											...
											<div class="kt-widget kt-widget--user-profile-4">
												<div class="kt-widget__head">
													<div class="kt-widget__media">
														<img class="kt-widget__img kt-hidden-" src="<?php echo BASE_URL ?>assets/media/users/300_2.jpg" alt="image">
